...
export class CubeSerialElement extends CubeElement {
    constructor(value1: number, value2: number, height: number, material: Material) {
        ...
        const v1 = value1, v2 = value2, h = height;
        const half = new Vector3(1, 0, 1).multiplyScalar(0.5);

        // points:
        const p11 = new Vector3(v2, 0, 0).sub(half), p12 = new Vector3(v2, h, 0).sub(half), p13 = new Vector3(v1, h, 0).sub(half), p14 = new Vector3(v1, 0, 0).sub(half);
        const p21 = new Vector3(v2, 0, v2).sub(half), p22 = new Vector3(v2, h, v2).sub(half), p23 = new Vector3(v1, h, v1).sub(half);
        const p31 = new Vector3(0, 0, v2).sub(half), p32 = new Vector3(0, h, v2).sub(half), p33 = new Vector3(0, h, v1).sub(half), p34 = new Vector3(0, 0, v1).sub(half);
